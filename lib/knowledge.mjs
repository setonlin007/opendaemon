...
const CATEGORIES = ["preferences", "patterns", "domain", "rules"];
...
/**
 * Search knowledge entries by keywords (matches against tags and title).
 */
export function searchKnowledge(keywords, maxResults = 10) {
  ...
  // Build OR conditions for each keyword against tags and title
