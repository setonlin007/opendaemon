...
import { getTracesSinceLastReflection, logEvolution } from "./trace.mjs";
 ...
 */
export function prepareReflection(traceLimit = 100) {
  const traces = getTracesSinceLastReflection(traceLimit);
