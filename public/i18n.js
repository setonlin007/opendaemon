...
I18N._translations = {
  en: {
    ...
    'usingOauth': 'Claude OAuth Authentication',
    ...
    'reflectionsRun': 'Reflections Run',
    'injectionEffectiveness': 'Injection Effectiveness',
    'chatsWithInjection': 'Chats w/ Injection',
    'feedbackWithInjection': 'Feedback (w/ Injection)',
    'chatsWithoutInjection': 'Chats w/o Injection',
    'feedbackWithoutInjection': 'Feedback (w/o Injection)',
    'statusTitle': 'Status',
    'convsSinceLast': 'Conversations since last',
    'badFeedbackSinceLast': 'Bad feedbacks since last',
    'pendingInsightsCount': 'Pending insights',

    // Agents tab
    'subAgentOrchestration': 'Sub-Agent Orchestration',
    'dispatchMode': 'Dispatch mode',
    'maxParallel': 'Max parallel',
    'agentTypes': 'Agent types',
    'recentRuns': 'Recent Runs (this conversation)',
    'noSubAgentRuns': 'No sub-agent runs in this conversation yet.',
    'selectConvForAgents': 'Select a conversation to see sub-agent runs.',
    'knowledgeEvaluator': 'Knowledge Evaluator',
    'runNextEvaluation': '▶ Run Next Evaluation',
    'totalEvaluations': 'Total Evaluations',
    'passed': 'Passed ✅',
    'flagged': 'Flagged ⚠️',
    'avgDelta': 'Avg Delta',
    'recentEvaluations': 'Recent Evaluations',
    'scoresWithout': 'Scores without',
    'scoresWith': 'Scores with',
    'scoreDelta': 'Score delta',
    'judgeReasoning': 'Judge reasoning',

    // A/B experiment form
    'experimentName': 'Experiment name',
    'minConvLabel': 'Min conversations:',
  ...
  zh: {
    ...
    // Stats tab
    'evolutionStats': '进化统计',
    'chatTokens': '对话 Tokens',
    'reflectionTokens': '反思 Tokens',
    'totalCost': '总费用',
    'positiveFeedback': '好评反馈',
    'knowledgeEntries': '知识条目',
    'reflectionsRun': '反思次数',
    'injectionEffectiveness': '注入效果',
    'chatsWithInjection': '有注入的对话',
    'feedbackWithInjection': '反馈（有注入）',
    'chatsWithoutInjection': '无注入的对话',
    'feedbackWithoutInjection': '反馈（无注入）',
    'statusTitle': '状态',
    'convsSinceLast': '上次以来的对话数',
    'badFeedbackSinceLast': '上次以来的差评数',
    'pendingInsightsCount': '待处理洞察',

    // Agents tab
    'subAgentOrchestration': '子智能体编排',
    'dispatchMode': '调度模式',
    'maxParallel': '最大并行数',
    'agentTypes': '智能体类型',
    'recentRuns': '最近运行（当前对话）',
    'noSubAgentRuns': '当前对话暂无子智能体运行记录。',
    'selectConvForAgents': '请选择一个对话查看子智能体运行记录。',
    'knowledgeEvaluator': '知识评估器',
    'runNextEvaluation': '▶ 运行下一次评估',
